package com.sleeve.tianqinrag.utils;
...
public class LogUtils {
    ...
    // 业务日志记录器
    private static final Logger BUSINESS_LOGGER = LoggerFactory.getLogger("com.sleeve.tianqinrag.business");

    // 性能日志记录器
    private static final Logger PERFORMANCE_LOGGER = LoggerFactory.getLogger("com.sleeve.tianqinrag.performance");
     ...
     * 记录文件操作日志
     */
    public static void logFileOperation(String userId, String operation, String fileName, String fileMd5,
            String result) {
        try {
            MDC.put(USER_ID, userId);
